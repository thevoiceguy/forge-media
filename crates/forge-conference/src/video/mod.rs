...
pub use room::{
    PassthroughMode, RecordRequest, RecordedFrame, RecordingSink, RemoteSpeaker, SubscribeRequest,
    VideoBackend, VideoFlavorInfo, VideoOutputInfo, VideoParticipantInfo, VideoRecordingInfo,
